...
<Link to="/First_chair"><Cards3 title="Chair" desc="Golden Easy Spot Chair" imgSrc="https://template.hasthemes.com/daxone/daxone/assets/images/product/pro-hm1-7.jpg" /></Link>
<div> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div> 
<h1> <p style={{fontSize:"5"}}></p>Life Style <br/><br/><br/><h2> LaaVista Depro, FX 829 v1 <br/><br/><br/></h2> <img src="./stars.JPG"></img>  <p style={{fontSize:"5"}}> <br/>Size: </p><p  style={{fontSize:"5"}}> S &nbsp;  M &nbsp;  XL &nbsp;  XXL</p><button className='button1'> SHOP NOW</button> <br/><br/><h1>$700.00 &nbsp; &nbsp; <s style={{fontSize:"2"}}>$550.00</s></h1></h1>
